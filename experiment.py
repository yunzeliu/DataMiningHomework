...
DATA_DIR = './dataset'
# def read_red_wine_quality(data_dir, file_name):
#     ''' Custom function to read the Red Wine Quality dataset '''
#     data_path = os.path.join(data_dir, file_name)
#     df = pd.read_csv(data_path)
#     X_df = df[df.columns[:-1]]  # Assuming last column is the target
