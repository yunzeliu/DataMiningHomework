...
parser.add_argument('-d', '--data_set', type=str, default='winequality-red',
...
parser.add_argument('--print_rule', default=True,
...
rrl_args.device_ids = [0]#list(map(int, rrl_args.device_ids.strip().split('@')))
